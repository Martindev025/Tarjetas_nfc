<div class="modal fade" id="{{ $isEdit && isset($product) ? 'editProductModal' . $product->id : 'createProductModal' }}" tabindex="-1" aria-labelledby="productModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ $isEdit && isset($product) ? route('products.update', $product) : route('products.store') }}" method="POST">
        @csrf
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select-custom " name="company_id" id="company_id" required>
              <option value="" disabled {{ !$isEdit ? 'selected' : '' }}>Seleccione una empresa</option>
